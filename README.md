...
|---|---|---|---|
| Fig. 1(a) SAOS moduli + FMG fit | `fig1a_saos_moduli.png` | `saos_moduli.csv` | analytic FMG, drawn for both 𝕍 = 1616 Pa·sᵅ (the value behind the published Fig. 1(a) curves) and 𝕍 = 4616 Pa·sᵅ (the value reported in the text) |
